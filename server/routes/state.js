...
// frontend used to keep in localStorage (watched / lastOpened /
// ritualCompletion / collapsed), just moved server-side and keyed by
// req.user.id (set by requireAuth) instead of a single shared browser.

import { db } from "../db.js";

const EMPTY_STATE = { watched: {}, lastOpened: {}, ritualCompletion: {}, collapsed: {} };
